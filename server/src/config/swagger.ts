      ...
      schemas: {
        ...
        Case: {
          ...
          properties: {
            ...
            coverImage: { type: 'string', description: '封面图' },
            ...
            views: { type: 'number', description: '浏览量' },
      ...
      '/cases': {
        get: {
          ...
          parameters: [
            ...
            { name: 'sort', in: 'query', schema: { type: 'string', enum: ['createdAt', 'views', 'favorites'] }, description: '排序字段' },
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  required: ['title', 'description', 'style', 'coverImage'],
                  properties: {
                    title: { type: 'string' },
